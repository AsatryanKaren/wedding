export const translations = {
  hy: {
    ...
    meta: {
      couple: "Կարեն Ասատրյան & Աննա Համբարձումյան"
    },
    hero: {
      ...
      date: "Հունիսի 24",
      time: "14:00",
      place: "Սուրբ Աննա եկեղեցի, Հայաստան",
    ...
    invitation: {
      ...
      body: [
        ...
        "Մեր կյանքի ամենանշանակալից պահերից մեկը ցանկանում ենք ապրել հենց ձեր հետ՝ աղոթքով ու օրհնությամբ։",
        "Խնդրում ենք միանալ մեր ամուսնության պսակադրության արարողությանը և կիսել այս ջերմ ու անկեղծ պահը մեր ընտանիքների հետ։"
      ],
      signature: "Սիրով՝ Կարեն և Աննա"
    },
    ceremony: {
      eyebrow: "Պսակադրություն",
      title: "Արարողության մանրամասներ",
      items: {
        date: { label: "Օր", value: "Հունիսի 24" },
        time: { label: "Ժամ", value: "14:00" },
        church: { label: "Եկեղեցի", value: "Սուրբ Աննա եկեղեցի" },
        location: { label: "Երկիր", value: "Հայաստան" }
      }
    },
    intimate: {
      eyebrow: "Մոտիկների շրջանակում",
      title: "Փոքր, իմաստալից արարողություն",
      body: [
        "Մեր հարսանիքը լինելու է փոքր և շատ անձնական՝ միայն պսակադրության արարողություն եկեղեցում։",
        "Չի լինելու առանձին մեծ խնջույք կամ հանդիսություն․ մեր ամենամեծ ցանկությունը ձեզ կողքիս զգալն է հենց այդ պահին։"
      ]
    },
    gift: {
      eyebrow: "Խնդրանք",
      title: "Ձեր ներկայությունն է ամենամեծ նվերը",
      body: [
        "Խնդրում ենք չմտածել նվերների մասին։",
        "Մեզ համար ամենաթանկը ձեր ներկայությունն է՝ ձեր օրհնությունն ու ջերմ խոսքը այդ օրը։"
      ]
    },
    map: {
      eyebrow: "Վայր",
    ...
    gate: {
      ...
      message:
        "Մենք սիրով հրավիրում ենք ձեզ մեր պսակադրության արարողությանը՝ կիսելու այս նշանակալից պահը միասին։",
      tagline: "Փոքր ու սրտանց արարողություն",
  ...
  en: {
    ...
    ceremony: {
      ...
      items: {
        ...
        church: { label: "Church", value: "Saint Anna Church, Abovyan St, Yerevan" },
